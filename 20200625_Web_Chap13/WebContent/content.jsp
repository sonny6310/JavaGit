		...
		<div class="container mt-3 chap13-bgColor">
			...
			<div class="row mt-1">
				<div class="col-md-12 chap13-center">
					<input type="button" value="글수정" onClick="document.location.href='updateForm.jsp?num=<%=one.getNum()%>&pageNum=<%=pageNum%>'" />
					<input type="button" value="글삭제" onClick="document.location.href='deleteForm.jsp?num=<%=one.getNum()%>&pageNum=<%=pageNum%>'" />
					<input type="button" value="목록보기" onClick="document.location.href='index.jsp?pageNum=<%=pageNum%>'" />
				</div>
			</div>
		</div>
	</form>

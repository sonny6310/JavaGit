...
<body>
	...
	<div class="container">
		<form method="post" onsubmit="return confirm('정말로 수정/삭제하시겠습니까?');">
			...
			<input type="submit" class="btn btn-default update" value="수정" onclick="javascript: form.action='update.ws';" /> <input type="submit" class="btn btn-default delete" value="삭제" onclick="javascript: form.action='delete.ws';"/>
		</form>
	</div>
</body>
</html>
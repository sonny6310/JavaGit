...
<head>
    ...
    <style>
        ...
        .center > .woman_center_text{
            ...
            height:300px;
            opacity: 0.9;
            background-image:url("${pageContext.request.contextPath}/resources/site/woman_center.jpg");
        ...
        .center > .man_center_text{
            ...
            height:300px;
            opacity: 0.9;
            background-image:url("${pageContext.request.contextPath}/resources/site/man_center.jpg");
            background-repeat:no-repeat;
            background-attachment:fixed;
            background-position:top;
            background-size:cover;

...
public class NaverLoginBO {
	private final static String CLIENT_ID = "Quz0SQXgpUE1GIFObj0j";
	private final static String CLIENT_SECRET = "JbpFRi3nPC";
	private final static String REDIRECT_URI = "http://localhost:10001/naver/login/callback";

...
<body>
	<div class="container p-3 mt-3 chap13-bgColor">
		<h1>JSP 13장</h1>
		<div class="btn-group btn-group-lg">
			<p>
				<a href="updateForm.jsp" class="btn btn-light">글 수정</a> <a href="deleteForm.jsp" class="btn btn-info">글 삭제</a> <a href="content.jsp" class="btn btn-light">글 읽기</a>
			</p>
		</div>
		<div class="container mt-5">
			...
			<table class="table table-hover mb-1">
				...
				<tbody style="background-color: #fafafa;">
					<tr onclick='row(<%=article.getNum()%>,<%=currentPage %>)' height="30">
						<td width="50">
							<%=number--%></td>
